...
\author{Trula Trulsson\\
		Truls Teknologsson} %%motionärernas namn, separera dem med radbrytningar: \\.
\title{Motion \\
	\normalsize{angående Hilbert Älgs horn}} %%Skriv det fulla, formella namnet. Endast det första ordet (Motion) samt egennamn skall skrivas med stor begynnelsebokstav.
...
\begin{signblock}
\vspace{15mm}
\emph{I \f -sektionens tjänst, } %%Eller något annat skojigt...
